                    ...
                    <td class="kv-content">
                     ...
                     <option value="-1">请选择批准人</option>
	                      <c:forEach items="${requestScope.taxers }" var="taxer">
                             <option value="${taxer.id }" ${taxer.id == requestScope.task.approverId ? "selected":""}>${taxer.taxerName }</option>
                          </c:forEach> 
	                    </select>
					</td>
                </tr>
                ...
                <tr>  
                  	...
                  	<td class="kv-content">    	
	                    ...
	                    <option value="-1">请选择执行人</option>
	                      <c:forEach items="${requestScope.taxers }" var="taxer">
	                            <option value="${taxer.id }" ${taxer.id == requestScope.task.executeId? "selected":""}>${taxer.taxerName }</option>
	                         </c:forEach> 
	                    </select>
                 	</td>
