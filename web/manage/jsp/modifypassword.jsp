  ...
  <script type="text/javascript" src="../../static/js/calendar.js"></script>
    ...
    $(function(){
    	$("#modify_pwd").on("click",function(){
            var password = "${sessionScope.user.password}";//获取初始密码
            var  eid="${sessionScope.user.id}";            //获取用户的id
        	...
        	$.post("updatePassword.do",{"eid":eid,"newPassword":newPassword},function(data){
        		if(data.success){
