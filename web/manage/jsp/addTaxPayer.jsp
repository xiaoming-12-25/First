     ...
     <div class="container">
        <div class="content">
            <div title="纳税人信息" data-options="closable:false" class="basic-info">
                ...
                <form id="addForm">
                    <input type="text" style="display: none" name="userId" value="${requestScope.user.id}"/>
                    <input type="text" style="display: none" name="recordDate" value="${requestScope.curDate }"/>
                <table class="kv-table" id="addPayer"><tbody>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="kv-content">
                            <select name="billType" name="invoiceType">
                                <option value="null">请选择发票种类</option>
                    ...
                    <tr>
                        ...
                        <td class="kv-content"> ${requestScope.curDate } </td>
                    </tr>
                    </tbody>
                </table>
                  </form>
